...
- External compaction owners should use `proactiveCompaction: false`, not passive mode: the workers and summary hook must remain active. The reproducible SoL-Pi experiment and its accounting limits live in `benchmarks/sol-pi/`.
<!-- opm:managed:end -->
